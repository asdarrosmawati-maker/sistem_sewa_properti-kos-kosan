<x-app>
    ...
    <div class="card shadow-lg p-3">
        ...
        <form action="{{ route('booking.update', $booking) }}" method="post" class="form">
            @csrf
            @method('put')
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('start_date') is-invalid @enderror" type="date" id="start_date"
                            name="start_date" required value="{{ old('start_date', $booking->start_date) }}">
                        @error('start_date')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('end_date') is-invalid @enderror" type="date" id="end_date"
                            name="end_date" required value="{{ old('end_date', $booking->end_date) }}">
                        @error('end_date')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('total_price') is-invalid @enderror" type="number" id="total_price"
                            name="total_price" required min="0" value="{{ old('total_price', $booking->total_price) }}">
                        @error('total_price')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select2-default @error('status') is-invalid @enderror" id="status" name="status" required>
                            ...
                            <option value="Active" @selected(old('status', $booking->status) == 'Active')>Active</option>
                            <option value="Completed" @selected(old('status', $booking->status) == 'Completed')>Completed</option>
                            <option value="Rejected" @selected(old('status', $booking->status) == 'Rejected')>Rejected</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">
                                {{ $message }}
