<x-app>
    ...
    <div class="card shadow-lg p-3">
        ...
        <form action="{{ route('expense.update', $expense) }}" method="post" class="form">
            @csrf
            @method('put')
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('expense_date') is-invalid @enderror" type="date" id="expense_date"
                            name="expense_date" required value="{{ old('expense_date', $expense->expense_date) }}">
                        @error('expense_date')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('description') is-invalid @enderror" type="text" id="description"
                            name="description" required value="{{ old('description', $expense->description) }}">
                        @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('amount') is-invalid @enderror" type="number" id="amount"
                            name="amount" required min="0" value="{{ old('amount', $expense->amount) }}">
                        @error('amount')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
