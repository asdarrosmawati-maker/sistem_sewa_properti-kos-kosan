<x-app>
    ...
    <div class="card shadow-lg p-3">
        ...
        <div class="mb-3">
            <a class="btn btn-primary" href="{{ route('payment.create') }}" role="button">Buat Pembayaran</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-info btn-sm btn-detail"
                                    data-route="{{ route('payment.show', $payment) }}">
                                    <i class='bx bx-show'></i>
                                </button>
                                <a href="{{ route('payment.edit', $payment) }}" class="btn btn-warning btn-sm">
                                    <i class='bx bx-edit-alt'></i>
                                </a>
                                <button type="button" class="btn btn-danger btn-sm btn-delete" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal" data-route="{{ route('payment.destroy', $payment) }}">
