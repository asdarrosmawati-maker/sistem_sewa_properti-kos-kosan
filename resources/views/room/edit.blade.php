                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select2-default @error('property_id') is-invalid @enderror" id="property_id" name="property_id" required>
                            ...
                            @foreach($properties as $property)
                                <option value="{{ $property->id }}" @selected(old('property_id', $room->property_id) == $property->id)>{{ $property->name }}</option>
                            @endforeach
                        </select>
                        @error('property_id')
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('price_per_month') is-invalid @enderror" type="number" id="price_per_month"
                            name="price_per_month" required min="0" value="{{ old('price_per_month', $room->price_per_month) }}">
